...
function eliminarFactura(req, res) {
  ...
  var idFactura = req.params.idFactura;
    ...
    Factura.findOneAndDelete(idFactura, (err, usuarioEliminado) => {
...
function eliminarEvento(req, res) {
  ...
  var idProd = req.params.idEvento;
    ...
    Eventos.findOneAndDelete(idProd, (err, usuarioEliminado) => {
...
function eliminarServicios(req, res) {
  ...
  Servicios.findOneAndDelete(idProd, (err, servicioEliminado) => {
...
function eliminarHabitaciones(req, res) {
  ...
  Habitaciones.findOneAndDelete(idProd, (err, habEliminada) => {
